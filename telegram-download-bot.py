...
TELEGRAM_BOT_TOKEN=getenv("TELEGRAM_BOT_TOKEN", "5167644119:AAG4r-qQCI22yCpItC4mDmbjWP_s2uSTejM") # <-- Configure here
TELEGRAM_CHAT_ID=getenv("TELEGRAM_CHAT_ID", "853523454") # <-- Configure here
TELEGRAM_REFRESH_SECONDS=getenv("TELEGRAM_REFRESH_SECONDS", 1)
DOWNLOADS_FOLDER=getenv("DOWNLOADS_FOLDER", "D:\Telegram Desktop")
# END CONFIGURATION
